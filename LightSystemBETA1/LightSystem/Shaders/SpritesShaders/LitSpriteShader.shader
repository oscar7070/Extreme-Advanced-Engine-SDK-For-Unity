...
////// Emissive:
                ...
                float3 emissive = (lerp(float3(1,1,1),saturate(3.0*abs(1.0-2.0*frac(node_5528.r+float3(0.0,-1.0/3.0,1.0/3.0)))-1),node_5528.g)*(node_5528.b*node_466.b));
